...
function () {
  function createIcons() {
    _classCallCheck(this, createIcons);
  }

  _createClass(createIcons, null, [{
    key: "createCrossIcon",
    // функция создания иконки закрытия
    value: function createCrossIcon() {
    ...
    key: "createArrowIcon",
    value: function createArrowIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    ...
    key: "createAddClientIcon",
    value: function createAddClientIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    ...
    value: function createSvgIcon() {
      ...
      svg.setAttribute("height", "16");
      svg.setAttribute("width", "16"); // Create circle element
      ...
      circle.setAttribute("stroke-width", "13.5px"); // Create group element

      var group = document.createElementNS("http://www.w3.org/2000/svg", "g");
      group.setAttribute("fill", "#9873FF"); // Create first rectangle element
      ...
      rect1.setAttribute("rx", "7"); // Create second rectangle element
      ...
      rect2.setAttribute("transform", "rotate(90 80 80)"); // Append elements

      group.appendChild(rect1);
      group.appendChild(rect2);
      svg.appendChild(circle);
      svg.appendChild(group); // Optionally, you can specify an element to append this SVG to
    ...
    key: "createFacebookIcon",
    value: function createFacebookIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      svg.setAttribute("width", "16");
      svg.setAttribute("height", "16");
      svg.setAttribute("viewBox", "0 0 16 16");
    ...
    key: "createPhoneIcon",
    value: function createPhoneIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      svg.setAttribute("width", "16");
      svg.setAttribute("height", "16");
      svg.setAttribute("viewBox", "0 0 16 16");
    ...
    key: "createEmailIcon",
    value: function createEmailIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      svg.setAttribute("width", "16");
      svg.setAttribute("height", "16");
      svg.setAttribute("viewBox", "0 0 16 16");
    ...
    key: "createContactIcon",
    value: function createContactIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      svg.setAttribute("width", "16");
      svg.setAttribute("height", "16");
      svg.setAttribute("viewBox", "0 0 16 16");
    ...
    key: "createArrowSelectIcon",
    value: function createArrowSelectIcon() {
      var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
